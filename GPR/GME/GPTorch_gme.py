...
train_x = torch.tensor(scaler.fit_transform(X_ordinal).flatten(), dtype=torch.float32)
train_y = torch.tensor(Y.flatten(), dtype=torch.float32)
...
test_x = train_x#torch.linspace(0, 1, num_samples)
